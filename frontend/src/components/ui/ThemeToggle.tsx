...
const ThemeToggle: React.FC<ThemeToggleProps> = ({ variant = 'fixed' }) => {
  ...
  return (
    <button
      onClick={toggleTheme}
      className="fixed top-4 right-4 z-[100] p-3 bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-full shadow-lg hover:shadow-xl transition-all hover:scale-110"
      title="Changer le thème"
      aria-label="Toggle theme"
    >
      {isDark ? (
